...
- **Photo Showcase**: High-quality camp images with hover effects and lightbox functionality
- **Responsive Design**: Mobile-first approach using Materialize CSS framework
- **Multi-language Support**: English, German, and Croatian language translations
- **Modern UI**: Custom color palette with seaside theme
